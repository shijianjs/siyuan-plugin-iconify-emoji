...
![Downloads](https://img.shields.io/badge/dynamic/json?url=http%3A%2F%2Fbazaar.b3logfile.com%2Fbazaar%2Findex.json&query=%24%5B%22shijianjs%2Fsiyuan-plugin-iconify-emoji%22%5D.downloads&label=Downloads)
...
| 版本 | 主要更新 |
|------|---------|
| v1.3.0 | 支持 YesIcon 多语言（如中文）搜索，可在 Iconify 官方和 YesIcon 之间切换 |
| v1.2.2 | 修复新图标提示延迟配置项 |
| v1.2.1 | 添加文档图标插入开关配置，优化图标提示触发逻辑，修复搜索防抖配置问题 |
| v1.2.0 | 添加图标搜索和插入的可配置选项（搜索限制、防抖延迟、插入延迟），修复首次使用图标显示问题 |
| v1.1.1 | 更新版本号 |
| v1.1.0 | 实现文档内容中图标插入与修改功能 |
| v1.0.0 | 首次发布，实现 Iconify 图标搜索与插入功能 |
